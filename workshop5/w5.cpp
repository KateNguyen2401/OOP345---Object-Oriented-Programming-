...
int main(int argc, char* argv[]) {
	...
	/*w5::Notifications n1 = w5::Notifications(notifications);
	w5::Notifications n2 = w5::Notifications(std::move(notifications));
	n1 = n2;
	n2 = std::move(n1);
	w5::Notifications* p = new w5::Notifications(notifications);
	delete p;*/
}